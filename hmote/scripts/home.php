...
$name = Member::getProperty($_SESSION['email'],"first_name")." ".Member::getProperty($_SESSION['email'],"last_name");
$location = "";
$businessName = "";
$city = Member::getProperty($_SESSION['email'],"city");
$state = Member::getProperty($_SESSION['email'],"state");
if($city != ""){
	$location .= $city;
}
...
$total_credits = number_format(Member::getProperty($_SESSION['email'],"total_credits"), 0, '.', ',');
...
$id = Member::getProperty($_SESSION['email'],"id");
$found = false;
